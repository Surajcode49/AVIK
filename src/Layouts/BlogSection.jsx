                ...
                <div className="blogs-cards" >
                    <article className="card card--1">
                        ...
                        <div className="card__info">
                            ...
                            <span className="card__by">
                                by <a href="#" className="card__author" title="author">Celeste Mills</a>
                            </span>
                        </div>
                    </article>
                    ...
                    <article className="card card--1">
                        ...
                        <div className="card__info">
                            ...
                            <h3 className="card__title">Studying Abroad
                                Start Your Study Abroad Journey with Pacific Educational Consultants
                            </h3>
                            <span className="card__by">
                                by <a href="#" className="card__author" title="author">Celeste Mills</a>
                            </span>
                    ...
                    <article className="card card--1">
                        ...
                        <div className="card__info">
                            ...
                            <span className="card__by">
                                by <a href="#" className="card__author" title="author">John Doe</a>
                            </span>
                        </div>
                    </article>
