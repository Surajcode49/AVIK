    ...
    return (
      ...
      <ul className="c-services">
        ...
        <li className="c-services__item">
          ...
          <p>
            We are Front End masters with a deep focus on HTML, CSS. The result of our work is responsive, accessible, and performant websites. Whether you have the design ready and want us to code it, or you want us to do both design and code, we’re happy to do so.
          </p>
        </li>
        <li className="c-services__item">
